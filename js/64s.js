...
d3.json("https://raw.githubusercontent.com/bienhuynh/XSMBView/main/data/resultlotterytable.json", function (error, data) {
    ...
    var isfirst = true;
    for (var iday = datelotterys.length - 1 - 0; iday >= 0; iday--) {
        _5day += 1;
        ...
        resultlotterybydate.forEach(function (element, index) {
            if (element.NameLottery === "G00") {
                ...
                rl_html += '<td class="text-center text-loterry ' + (_64s.includes(parseInt(g00_2)) ? "text-true" : "text-fail") + '">' + element.Value + '</td>';
                ...
                profit_g00_64s = (_64s.includes(parseInt(g00_2)) ? (99 - _64s.length) * start_point : -1 * _64s.length * start_point);
                oychart1.push(oychart1[oychart1.length - 1] + profit_g00_64s);
                profit_g00_3d_5days += (_64s.includes(parseInt(g00_2)) && _3ds.includes(parseInt(element.Value[2]))) ? (972.5 - _64s.length * _3ds.length) * start_point : -1 * _64s.length * _3ds.length * start_point;
            ...
            if (element.NameLottery === "G11") {
                ...
                rl_html += '<td class="text-center text-loterry ' + (_64s.includes(parseInt(g11_2)) ? "text-true" : "text-fail") + '">' + element.Value + '</td>';
                ...
                profit_g11_36s = (_64s.includes(parseInt(g11_2)) ? (99 - _64s.length) * start_point : -1 * _64s.length * start_point);
                oychart2.push(oychart2[oychart2.length - 1] + profit_g11_36s);
                profit_g11_3d_5days += (_64s.includes(parseInt(g11_2)) && _3ds.includes(parseInt(element.Value[2]))) ? (972.5 - _64s.length * _3ds.length) * start_point : -1 * _64s.length * _3ds.length * start_point;
